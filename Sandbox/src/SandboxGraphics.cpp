...
SandboxGraphics::SandboxGraphics()
	: Layer("SandboxGraphics"), m_CameraController(45.0f, (float)1280/(float)720, 0.01f, 100.0f)
{
}
...
void SandboxGraphics::OnUpdate(Titan::Timestep ts)
{
	...
	Titan::SceneDeferred::Pass1(m_CameraController.GetCamera());
	...
	Titan::SceneDeferred::Pass2(m_CameraController.GetCamera());
