...
SandboxClusterShading::SandboxClusterShading()
	: Layer("SandboxClusterShading"), m_CameraController(45.0f, (float)1280/(float)720, 0.01f, 1000.0f)
{
}

void SandboxClusterShading::OnAttach()
{
	...
	std::function<void(const std::shared_ptr<Titan::Shader>&)> drawObj = std::bind(&SandboxClusterShading::DrawSceneObjects, this, _1);
	m_ClusteredRenderer.PointLightPass(m_PointLights, drawObj);
}

void SandboxClusterShading::OnDetach()
{

}

void SandboxClusterShading::DrawSceneObjects(const std::shared_ptr<Titan::Shader>& shader)
{
...
void SandboxClusterShading::OnUpdate(Titan::Timestep ts)
{
...
void SandboxClusterShading::OnImGuiRender()
{
	//Camera and Lighting
...
void SandboxClusterShading::OnEvent(Titan::Event& event)
{
